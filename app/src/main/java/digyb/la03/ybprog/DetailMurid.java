...
public class DetailMurid extends AppCompatActivity {
    ...
    TextView a,b,c,d,e,f,nama,info;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent iNama = getIntent();
         tNama = iNama.getStringExtra("nama");
...
//
//         Config.sNama = tNama.toString().trim();
//
//         final String URL_LIST2 = "https://portly-drainage.000webhostapp.com/isi/list_murid2.php?nama="+Config.sNama;
//
//
//            final ProgressDialog prog = ProgressDialog.show(DetailMurid.this,"","Loading....",true);
//
//            //Creating a string request
////            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_LIST2,
...
////        }
    ...
    public void diget()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_LIST2, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    String sInfo = data.getString("info");
